                  ...
                  @foreach($revisions as $revision)
				   @if($revision->document())
					<tr data-id="{{$revision->id}}" >
					  ...
					  <td class="align-middle full-width pl-2 pr-4"><a class="" title="Category" href="{{route('mediateka.index')}}?type=documents&parent_id={{$revision->document()->category_id}}" target="_blank">{{ $revision->document()->category()->name_ru }}</a></td>
