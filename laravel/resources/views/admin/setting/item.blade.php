  ...
  <div class="content-wrapper form_zone">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0 text-dark">Настройки <span>{{ request()->routeIs('setting.edit') ? '(Редактирование)': ''}} {{ request()->routeIs('setting.create') ? '(Создание)' : ''}}</span></h1>
          </div><!-- /.col -->
          <div class="col-sm-4">
            <button type="submit" class="btn btn-info float-right ml-2 mb-2 trigger_btn_save">Сохранить</button>            
			<a href="{{route('setting.index')}}" class="btn btn-primary float-right">Назад</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
